...
class NewsBlockComponentPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      imageBase64: null,
      imageURL:
        'https://www.sussexstudent.com/asset/News/6667/uk.jpg?thumbnail_width=200&thumbnail_height=160&resize_type=CropToFit',
    };
  ...
  render() {
    ...
    return (
      <div className="App__content-container">
        <h1>NewsBlock</h1>
        <p>
          Our news block is an item-in-list element for displaying articles.
        </p>
        <div className="Trail">
          <div className="Trail__row Trail__row--11">
            <div className="NewsBlock">
              <a className="NewsBlock__title-link" href="https://example.com/">
                <div
                  ...
                  style={{ backgroundImage: `url(${imageBase64 || imageURL})` }}
                >
                  <div className="NewsBlock__title-outer">
                    <h2 className="NewsBlock__title" contentEditable>
                      {title}
                    </h2>
                  </div>
                </div>
              </a>
              <p className="NewsBlock__standfirst" contentEditable>
                {standfirst}
              </p>
            ...
            <div>
              ...
              <Dropzone onDrop={this.handleSetImage}>Drop image here.</Dropzone>
              <input
                type="text"
                value={standfirst}
                onChange={this.handleStandfirst}
              />
            </div>
          </div>
        </div>
