      ...
      <div className="Layout Layout--sidebar-left">
        <div>
          <aside>
            <div className="ContentCard">
              If you would like to find out more about the Students' Union's ethical and environmental work, or if you have any suggestions or information that might be useful please contact our Environmental Assistant at
              {' '}
        ...
        <div>
          ...
          <div className="ContentCard">
            ...
            <p>
              Some of the things we have been, and are focusing on include: monitoring our carbon footprint, reducing food waste in our bars, identifying sustainability within the curriculum, referencing sustainability in the job descriptions of all new staff and encouraging ethical and environmental purchase choices.
            </p>
            <p>
              Union staff and officers are encouraging students to be more involved in this process so if you have any opinions, input and/or campaign suggestions to include in the process please contact our Environmental Assistant
              {' '}
          ...
          <div className="ContentCard">
            ...
            <p>
              At the end of the summer term when students move out of on-campus University managed accommodation, we work with
              {' '}
              <a href="http://www.sussex.ac.uk/sef/">Sussex Estates</a>
              {' '}
              and Facilities to collect unwanted items. Some items, including food are distributed to local charities such as
              {' '}
              ...
              . The rest of the items are sorted and cleaned for students to collect in Freshers Week, helping you to kit-out your kitchen and organise your bedroom. This helps to avoid many good items being sent to landfill.
            </p>
            <p>
              The Free Shop is open all year around, located outside of Meeting Room 1 in Falmer House so if you have any items you would like to pass on or want to see if there is anything that might take your fancy then do drop-by and take a look.
            </p>
            <p>
          ...
          <div className="ContentCard">
            ...
            <p>
              Sarah, the Students’ Union’s Society & Citizenship Officer as part of her manifesto is setting-up and running a Food Waste Cafe on campus along with students.
            </p>
            <p>
              The aim of the project is to use food collected from around our campus, and with the help of the
              {' '}
              <a href="http://www.realjunkfoodbrighton.co.uk/">
                Real Junk Food Project
              </a>
              , to create a delicious menu for everyone to enjoy. For a while you’ll find the café in a pop up van on campus, so keep your eyes peeled!
            </p>
            <p>
            ...
            <p>
              ...
              {' '}
              to find about her other environmental ideas and initiatives across the University.
            </p>
          </div>
        </div>
      </div>
