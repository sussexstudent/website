  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          Promoting the Students’ Union values and working with other organisations who share our values
          {' '}
          <em>11</em>
        </li>
      </ul>
        ...
        <div aria-hidden="true" className="QuoteSlips__answer">
          <div className="QuoteSlips__answer-container">
            <em className="QuoteSlips__answer-intro">
              Select a card to find out what the SU is doing in regards to these points
            </em>
          </div>
        </div>
      </div>
