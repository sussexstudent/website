  ...
  <Route
    ...
    component={() => (
      <Switch>
        ...
        <Route path={`/book-market/section/:sectionSlug`} component={MarketSection} />
        <Route path={`/book-market/listing/:listingId`} component={BookDetail} />
...
export default HydroLeaf({ disableSSR: true, name: 'BookMarket', providers: [Provider.Apollo, Provider.Router] })(
