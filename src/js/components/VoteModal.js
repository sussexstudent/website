...
const svg = (
  <svg width="310px" height="43px" viewBox="0 0 310 43" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
function VoteModal() {
  return (
    <a href="/vote/" className="VoteModal">
      <section>
        <div>Get involved.</div>
        <div>Be part of making change happen.</div>
        <div className="VoteModal__button">{svg}</div>
        <div>Voting for the Union elections and referenda closes Fri 3rd March at 5pm.</div>
      </section>
    </a>
  );
}
