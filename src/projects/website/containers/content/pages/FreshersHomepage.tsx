...
class FreshersHomepage extends React.Component<{}, { showVideo: boolean }> {
  constructor(props: {}) {
    ...
    this.handleSneakPeakClick = this.handleSneakPeakClick.bind(this);
  }

  handleSneakPeakClick() {
        ...
        <div className="FreshersHomepage">
          ...
          <div className="FreshersHomepage__slice FreshersHomepage__slice--events">
            <div className="LokiContainer">
              ...
              <EventsButton to="/freshers/whats-on">
                See the schedule >
              </EventsButton>
            </div>
          </div>
          {showVideo ? (
            ...
            <OneImageBackground
              ...
              aspectRatio={AspectRatio.r16by9}
            >
              <button onClick={this.handleSneakPeakClick}>
                <h1>Sneak Peek</h1>
              </button>
            </OneImageBackground>
          )}
              ...
              <div className="FGT__header">
                <div>
                  ...
                  <p>
                    ...
                    bird sale, The Golden Ticket is very popular and when
            ...
            <div className="LokiContainer">
              ...
              <div className="FUnion__areas">
                <div>
                  ...
                  <p>
                    We have over 200 societies and sports clubs, and you can
                    join as many as you like from the first week. We help run a
                    whole range of groups including sports, performing arts,
                    political, music,crafts. LGBTQ+ and religious societies, so
                    there’s bound to be something for you. If nothing we have
                    takes your fancy, we can help you start your very own
                    society.
                  </p>
                ...
                <div>
                  <h3>Jobs</h3>
                  <p>
                    We have many jobs on offer for new and returning students.
                    We employ students in our outlets and beyond to help make
                    our Students’ Union the best it can be.
                  </p>
